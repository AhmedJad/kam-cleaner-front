...
declare var $: any;
@Component({
  selector: 'app-about-us-counter',
  templateUrl: './about-us-counter.component.html',
  styleUrls: ['./about-us-counter.component.scss']
})
export class AboutUsCounterComponent implements OnInit {
  counters: any = [];
  limit = 4;
